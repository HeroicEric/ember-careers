...
window.startApp          = require('ember-careers/tests/helpers/start_app')['default'];
window.isolatedContainer = require('ember-careers/tests/helpers/isolated_container')['default'];
